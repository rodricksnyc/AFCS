     ...
     $.fn.tipuesearch = function(options) {
          ...
          return this.each(function() {
            ...
            $("#tipModal").append('<div id="tipue_search_error"></div>');
                    ...
                    $('#tipue_search_replaced').click(function(e) {
												e.preventDefault();
                    ...
                    $('.tipue_search_related_btn').click(function(e) {
											e.preventDefault();
                    ...
                    $('.tipue_search_image_zoom').click(function(e) {
                    ...
                    $('.tipue_search_image_close').click(function(e) {
                    ...
                    $('.tipue_search_foot_box').click(function(e)  {
