          ...
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent">
                ...
                <p class="small">Keeping our nuclear arsenal ready, reliable, up to date, and strategic. That’s an awesome responsibility. It’s essential to world peace. America’s nuclear capabilities are vital to our ongoing commitment to deterring a world war or other large conflict. The Air Force Nuclear Weapons Center (AFNWC) is at the heart of that vital commitment by maintaining the most powerful and sophisticated weapons in the history of the world like intercontinental ballistic missiles and air-launched cruise missiles.</p>
              </div>
              <p class="small content-middle transparent">We safely and proactively extend the life cycle of the weapons that make up our nuclear arsenal.</p>

              <div class="content-bottom transparent">
                <p class="small">We modernize and modify our weapons capabilities to meet the demands of a complex military landscape with nuclear states and non-state actors that threaten regional and global stability.</p>

                <p class="small">We ensure the disposal and demilitarization of excess military weapon systems and materials to prevent their acquisition and use by private civilians and potential enemies of the U.S.</p>
                <h1 class="acq">Awesome Indeed</h1>
              </div>
              ...
              <div style="-webkit-box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);-moz-box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);">
                <div class="m-carousel">
                  <div class="m-carousel__item one">
                    <img id="myImg" class="m-carousel__image" data-flickity-lazyload="images5/nuclear1.jpg" alt="Nuclear simulation training">
                    <div class="custCaption1"><p class="endDescription">Nuclear simulation training</p></div>
                  </div>

                  <div class="m-carousel__item two">
                    <img id="myImg2" class="m-carousel__image" data-flickity-lazyload="images5/test-benefits1.jpg" alt="Senior Airman Jennifer Peterson (left) and Staff Sgt. Jeremiah Phelps prepare to move Mark 84 bombs inside a hardened structure April 21, 2010, at Ellsworth Air Force Base, S.D.">
                    <div class="custCaption2"><p class="endDescription">Senior Airman Jennifer Peterson (left) and Staff Sgt. Jeremiah Phelps prepare to move Mark 84 bombs inside a hardened structure April 21, 2010, at Ellsworth Air Force Base, S.D.</p></div>
                  </div>

                  <div class="m-carousel__item three">
                    <img id="myImg3" class="m-carousel__image" data-flickity-lazyload="images5/nuclear2.jpg" alt="Communications expert calibrating monitoring equipment">
                    <div class="custCaption3"><p class="endDescription">Communications expert calibrating monitoring equipment</p></div>
                  </div>

                  <div class="m-carousel__item four">
                    <img id="myImg4" class="m-carousel__image" data-flickity-lazyload="images5/nuclear3.jpg" alt="Missile silo maintenance tower">
                    <div class="custCaption4"><p class="endDescription">Missile silo maintenance tower</p></div>
                  </div>

                  <div class="m-carousel__item five">
                    <img id="myImg5" class="m-carousel__image" data-flickity-lazyload="images5/nuclear4.jpg" alt="Ballistic missile silo">
                    <div class="custCaption5"><p class="endDescription">Ballistic missile silo</p></div>
                  </div>

                  <div class="m-carousel__item six">
                    <img id="myImg6" class="m-carousel__image" data-flickity-lazyload="images5/nuclear5.jpg" alt="B-2B Lancer on the tarmac">
                    <div class="custCaption6"><p class="endDescription">B-2B Lancer on the tarmac</p></div>
                  </div>
          ...
          <div class="row heros">
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent">
                ...
                <p class="small">Civilians at AFNWC work shoulder to shoulder with our military and contractor partners to help deter and assure against military and unconventional threats. And we strive, by maintaining tight nuclear situational awareness, to strengthen the Air Force’s responsibilities to the national nuclear enterprise.</p>
              </div>

              <div class="content-middle transparent">
                <p class="small">We are daily deterring nations that have or aspire to obtain nuclear capabilities from using them against the United States and our allies, and threatening our safety and way of life.</p>
              </div>

              <div class="content-bottom transparent">
                <p class="small">Likewise, we are assuring our friends and allies of our resolve and capability to execute against threats by maintaining reliable, responsive nuclear capabilities at the highest level of readiness at all times.</p>
          ...
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent" style="-webkit-box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);-moz-box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);">
                ...
                <iframe src="https://www.youtube.com/embed/PerN17xzxPs" title="Video: Nuclear Weapons Center Overview" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
        ...
        <div class="row heros">
          <div class="col-xs-12 col-lg-12">
            <div class="content-top transparent">
              ...
              <p class="small">Established in 2006 at Kirtland Air Force Base in New Mexico, AFNWC is the center of America's deterrent operations. As part of the Air Force Acquisition team, we acquire, sustain, modernize, and support the nation's most powerful weapon systems – our nuclear arsenal—for the safety and security of the United States, and the world.</p>
            </div>
            <div class="content-middle transparent">
              <p class="small">We offer a unique experience that civilians won’t find anywhere else. Period. Hardware and software engineers, program managers, logistics specialists, financial and contracting management professionals—not to mention nuclear engineers—will find the challenge and rewards unlike anywhere else on the planet.</p>
            </div>
        ...
        <div class="row heros">
          ...
          <div class="col-xs-12 col-lg-12">
            <div class="content-top transparent" style="-webkit-box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);-moz-box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);">
              ...
              -moz-box-shadow: 0px 10px 17px 3px rgba(0,0,0,0.56);
              box-shadow: 0px 10px 17px 3px rgba(0,0,0,0.56);">
              <iframe src="https://www.youtube.com/embed/kNqS2WyA5hE" title="Occupation video: Nuclear Engineering" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
    ...
    <div class="container-fluid w800">
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <p class="small content-top transparent">AFNWC is part of the Air Force Civilian Service (AFCS). That’s the indispensable force that provides the brain power and manpower that keep the Air Force ready for action.</p>
    ...
    <div class="row heros">
      <div class="col-xs-12 col-lg-12">
        ...
        <div class="bluish3 content-middle transparent">
          <div class="bluishButton"><a class="white" href="roa.php" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Nuclear page');">Register</a></div>
...
<script src="js5/nuclear.js"></script>
