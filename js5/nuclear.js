   ...
   setTimeout(function(){
     ...
     $('#news').addClass('animated slideInRight').show();
          ...
          $('#getFile6').on('click', function () {
            $.ajax({
              url: 'http://www.elizabethrodricks.com/images5/nuclear1.jpg',
              method: 'GET',
              xhrFields: {
                responseType: 'blob'
              },
       ...
       $('#getFile7').on('click', function () {
            $.ajax({
              url: '/images5/test-benefits1.jpg',
              method: 'GET',
              xhrFields: {
                responseType: 'blob'
              },
