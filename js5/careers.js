$(document).ready(function () {
  ...
  let pageModule = {
    ...
    getBlocksFixedHeight: function() {
      var blocks = pageModule.config.classes.blocks

      let blocksHeight = $(blocks).height();
      console.log(`blocks height is ${blocksHeight}`);
  ...
  $("#myCool .close").on("click", function(){
    ...
    $('.bottomFlickity').removeClass('mt0');
    ...
    setTimeout(function(){
      $('#hiddenVideos').removeClass('bottomShadowNone');
      $('#myCool').removeClass('bottomShadowNone');
      $('#news').removeClass('bottomShadowNone');
    },1100);
  ...
  $(document).on('click', ".openIt2", function() {
    ...
    $('.bottomFlickity').addClass('mt0');



    if ($('#news').is('.myNews', '.bottomShadowNone', '.animated', '.slideInRight') && $('#hiddenVideos').is('flexing-scroll'))  {
    ...
    else if ($('hiddenVideos').is('.bottomShadowNone', '.flexing-scroll') && $('#news').is('.myNews', '.animated', '.slideInRight')) {
    ...
    ($('#hiddenVideos').is('.bottomShadowNone')) {

      console.log('videos has bottomShadowNone')
    ...
    (!$('#myCool').is('.bottomShadowNone')  && !$('#hiddenVideos').is('.bottomShadowNone') && !$('#news').is('.bottomShadowNone')) {

      console.log('videos does not have bottomShadowNone')
    ...
    (!$('#myCool').is('.bottomShadowNone')  && !$('#hiddenVideos').is('.bottomShadowNone') &&  $('#myCool').is('.cool', '.flexing-scroll') && $('#news').is('.myNews' , '.bottomShadowNone' , '.animated' , '.slideInRight')) {
    ...
    ($('#myCool').is('.bottomShadowNone', '.cool', '.flexing-scroll') && $('#hiddenVideos').is('.flexing-scroll') && !$('#news').is('.bottomShadowNone'))  {
      ...
      ($('#myCool').is('.bottomShadowNone', '.cool', '.animated', '.slideInRight')  && $('#hiddenVideos').is('.flexing-scroll')) {
        ...
        ($('#myCool').is('.cool', '.flexing-scroll') && $('#hiddenVideos').is('.bottomShadowNone' , '.animated' , '.slideInRight') && $('#news').is('.myNews', '.flexing-scroll')) {
          ...
          ($('#myCool').is('.bottomShadowNone', '.cool', '.flexing-scroll') && !$('#hiddenVideos').is('.bottomShadowNone') && !$('#news').is('.bottomShadowNone'))   {

            console.log('mycool got the bottomShadowNone')
          ...
          ($('#myCool').is('.cool' , '.flexing-scroll') && $('#news').is('.myNews' , '.flexing-scroll' , '.bottomShadowNone' , '.animated' , '.slideInRight') ) {
        ...
        $(document).on('click', ".openIt", function() {
          ...
          ($('#myCool').is('.bottomShadowNone', '.cool', '.flexing-scroll')  && $('#news').is('.myNews' , '.bottomShadowNone' , '.animated' , '.slideInRight')) {
            ...
            setTimeout(function(){
            ...
            else if ($('#myCool').is('.cool', '.flexing-scroll') && $('#hiddenVideos').is('.animated', '.slideInRight', '.bottomShadowNone'))  {
              ...
              ($('#myCool').is('.cool', '.flexing-scroll') && $('#hiddenVideos').is('.bottomShadowNone' , '.animated' , '.slideInRight') && $('#news').is('.myNews', '.flexing-scroll')) {
                ...
                setTimeout(function(){
                ...
                else if  ($('#myCool').is('.bottomShadowNone', '.cool', '.flexing-scroll') && $('#news').is('.myNews', '.animated', '.slideInRight') && $('#hiddenVideos').is('.animated', '.slideInRight', '.flexing-scroll')) {
                  ...
                  (!$('#myCool').is('.bottomShadowNone')  && !$('#hiddenVideos').is('.bottomShadowNone') && !$('#news').is('.bottomShadowNone')) {
                    console.log('cool no bottomShadowNone')
                  ...
                  ($('#hiddenVideos').is('.bottomShadowNone') && !$('#myCool').is('.bottomShadowNone') && !$('#news').is('.bottomShadowNone')) {
                    console.log('videos has bottomShadowNone and myCool does not')
                    ...
                    (!$('#myCool').is('.bottomShadowNone')  && !$('#hiddenVideos').is('.bottomShadowNone') && $('#news').is('.bottomShadowNone'))   {
                      console.log('news has bottomShadowNone and myCool and videos does not')
                      ...
                      ($('#myCool').is('.cool' , '.bottomShadowNone', '.flexing-scroll') && $('#news').is('.myNews', '.bottomShadowNone' , '.animated' , '.slideInRight')) {
                    ...
                    $(document).on('click', ".openIt3", function() {
                      ...
                      if (!$('#news').is('.bottomShadowNone') && !$('#myCool').is('.cool', '.bottomShadowNone', '.slideInRight', '.animated')) {

                        console.log('news no bottomShadowNone and open')
                      ...
                      if (!$('#news').is('.bottomShadowNone') && !$('#hiddenVideos').is('.bottomShadowNone') && !$('#myCool').is('.bottomShadowNone')) {
                      ...
                      ($('#news').is('.myNews' , '.bottomShadowNone', '.animated', '.slideInRight') && $('#hiddenVideos').is('.flexing-scroll') && !$('#myCool').is('.cool' , '.bottomShadowNone', '.animated' , '.slideInRight')) {
                      ...
                      else if ($('#myCool').is('.cool', '.bottomShadowNone', '.animated', '.slideInRight') && $('#hiddenVideos').is('.flexing-scroll')) {
                        ...
                        setTimeout(function(){
                          // $('#hiddenVideos').css('position','unset');
                          $('#news').addClass('bottomShadowNone');
                          $('#calendar').addClass('bottomShadowNone');
                          $('#myCool').removeClass('bottomShadowNone');
                      ...
                      else if($('#news').is('.bottomShadowNone', '.cool', '.flexing-scroll')) {
                      ...
                      ($('#myCool').is('.bottomShadowNone')  || $('#myCool').is('.bottomShadowNone', '.animated', '.slideInRight') && !$('#news').is('.bottomShadowNone')) {
                        ...
                        setTimeout(function(){
                          ...
                          $('#news').addClass('bottomShadowNone')
                          $('#cool').removeClass('bottomShadowNone')
                      ...
                      (!$('#myCool').is('.bottomShadowNone') && $('#news').is('.flexing-scroll') && $('#hiddenVideos').is('.animated' , '.slideInRight')) {
                      ...
                      ($('#news').is('.myNews' , '.bottomShadowNone', '.animated', '.slideInRight') && $('#hiddenVideos').is('.flexing-scroll'))
...

                      {
                        ...
                        ($('#myCool').is('.cool' , '.bottomShadowNone')) {
                      ...
                      $('.whiteLink.veterans').on('click' , function() {
                      ...
                      $('.whiteLink.military').on('click' , function() {
                      ...
                      $('.whiteLink.disabilities').on('click' , function() {
                      ...
                      $('.whiteLink.training').on('click' , function() {
                      ...
                      $('.whiteLink.whyAfcs').on('click' , function() {
                        var divPosition = $('#anchorPoint2').offset();
                        $('html, body').animate({scrollTop: divPosition.top}, 1000);
                      ...
                      $('.whiteLink.security').on('click' , function() {
                      var divPosition = $('#anchorPoint2').offset();
                      $('html, body').animate({scrollTop: divPosition.top}, 1000);
                    ...
                    $('.whiteLink.workLife').on('click' , function() {
                      var divPosition = $('#anchorPoint2').offset();
                      $('html, body').animate({scrollTop: divPosition.top}, 1000);
                    ...
                    $('.whiteLink.benefits').on('click' , function() {
                      var divPosition = $('#anchorPoint2').offset();
                      $('html, body').animate({scrollTop: divPosition.top}, 1000);
                    ...
                    $('.whiteLink.opportunity').on('click' , function() {
                      var divPosition = $('#anchorPoint2').offset();
                      $('html, body').animate({scrollTop: divPosition.top}, 1000);
