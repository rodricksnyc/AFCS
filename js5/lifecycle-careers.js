    ...
    for (var i=1;i<2;i++) {
      ...
      next.children(':first-child').clone().appendTo($(this));
          ...
          $('#getFile6').on('click', function () {
            $.ajax({
              url: 'http://www.elizabethrodricks.com/images5/lifecareer1.jpg',
              method: 'GET',
              xhrFields: {
                responseType: 'blob'
              },
      ...
      $('#getFile8').on('click', function () {
         ...
         $('#getFile9').on('click', function () {
           ...
           $('#getFile15').on('click', function () {
             $.ajax({
               url: '/images5/lifecareer-last.jpg',
               method: 'GET',
               xhrFields: {
                 responseType: 'blob'
               },
