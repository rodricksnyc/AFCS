...
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
  ...
  <div class="nav-container">
    <div class="brand">
      <!-- <a class="navbar-brand" href="afcs-homepage.php">
        <img class="img-responsive navLogo" src="images5/afcs-navbar.png">
      </a> -->
    </div>
    <nav class="secondNav">
      ...
      <ul class="nav-list">
        <li>
          <a href="acquisition.php">Acquisition Force</a>
        </li>
        <li>
          <a id="test" href="testing.php">Testing</a>
          <!-- <ul id="testDrop" class="nav-dropdown">
            <li>
              <a href="testing.php">Testing</a>
            </li>
            <li>
              <a href="testing-careers.php">Careers</a>
            </li>
            <li>
              <a href="testing-benefits.php">Benefits</a>
            </li>
            <li>
              <a href="testing-locations.php">Locations</a>
            </li>
          </ul> -->
        </li>
        <li>
          <a id="nuc" href="nuclear.php">Nuclear Arms</a>
          <!-- <ul id="nucDrop" class="nav-dropdown">
            <li>
              <a href="nuclear.php">Nuclear</a>
            </li>
            <li>
              <a href="nuclear-careers.php">Careers</a>
            </li>
            <li>
              <a href="nuclear-benefits.php">Benefits</a>
            </li>
            <li>
              <a href="nuclear-locations.php">Locations</a>
            </li>
          </ul> -->
        </li>
        <li>
          <a id="maint" href="maintenance.php">Maintenance</a>
          <!-- <ul id="maintDrop" class="nav-dropdown">
            <li>
              <a href="maintenance.php">Maintenance</a>
            </li>
            <li>
              <a href="maintenance-careers.php">Careers</a>
            </li>
            <li>
              <a href="maintenance-benefits.php">Benefits</a>
            </li>
            <li>
              <a href="maintenance-locations.php">Locations</a>
            </li>
          </ul> -->
        </li>
        <li>
          <a id="rd" href="lifecycle.php">R & D</a>
          <!-- <ul id="rdDrop" class="nav-dropdown">
            <li>
              <a href="lifecycle.php">Research</a>
            </li>
            <li>
              <a href="lifecycle-careers.php">Careers</a>
            </li>
            <li>
              <a href="lifecycle-benefits.php">Benefits</a>
            </li>
            <li>
              <a href="lifecycle-locations.php">Locations</a>
            </li>
          </ul> -->
        </li>
        <li>
          <a id="sm" href="smsc.php">Space & Missiles</a>
          <!-- <ul id="smDrop" class="nav-dropdown">
            <li>
              <a href="smsc.php">Space & Missiles</a>
            </li>
            <li>
              <a href="smsc-careers.php">Careers</a>
            </li>
            <li>
              <a href="smsc-benefits.php">Benefits</a>
            </li>
            <li>
              <a href="smsc-locations.php">Locations</a>
            </li>
          </ul> -->
        </li>
      </ul>
