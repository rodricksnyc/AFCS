        ...
        <div class="container-fluid w800">
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              ...
              <h1 class="acq noMargin content-middle transparent">for Air Force families</h1>

              <p class="small content-bottom transparent">300,000 men and women in uniform and their families rely on services that keep them safe and well-adjusted to the special routine and pressures they face in service to our nation.</p>

              <p class="small content-last transparent">Our family support and social services team work with individuals and families to address needs as they arise and provide relief and assistance when circumstances become challenging. The health and welfare of each person and family is a priority as programs and services are delivered.</p>

              <p class="small content-secondLast transparent">Unlike our counterparts in other social services environments, we at AFCS not only provide support but are also committed to something extremely important: we work every day in the defense of our nation and the values we hold dear.</p>

              <p class="small content-thirdLast transparent">If you are interested in exploring AFCS opportunities in social services and related fields, register here to receive up-to-the-minute job openings as they become available.</p>
      ...
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <div class="bluish3 content-middle transparent">
            <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA', 'click', 'Social Services page');">Register</a></div>
            <div class="bluishButton new">
              <a class="white" href="careers.php#occupations" onclick="ga('send', 'event', 'Go to Careers', 'click', 'Social Services page');">Back to Occupations</a>
            </div>
