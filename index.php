                  ...
                  <div class="spaceAround" style="max-width:1200px;">
                    ...
                    <div class="flexCol">
                      <ul class="footer-links">
                        <li class="smaller2"><a class="whiteLink two" href="#veryTop" id="veryBottom"><strong>HOME</strong></a></li>
                        <li class="smaller"><a class="whiteLink news" href="#top" id="bottom">News</a></li>
                        <li class="smaller"><a class="whiteLink events" href="#top" id="bottom">Events</a></li>
                        <li class="smaller"><a class="whiteLink videos" href="#top" id="bottom">Videos</a></li>
                        <br>
                    ...
                    <div class="flexCol">
                      ...
                      <ul class="footer-links">
                        ...
                        <li class="smaller"><a class="whiteLink" href="careers.php#careerSecondAnchor">Training</a></li>
                        <li class="smaller"><a class="whiteLink" href="careers.php#careerSecondAnchor">Job Security</a></li>
                        <li class="smaller"><a class="whiteLink" href="careers.php#careerSecondAnchor">Opportunity</a></li>
                            ...
                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                              <div class="card-body">
                                <ul style="padding-top:1em;">
                                  <li class="smaller3"><a class="whiteLink news" href="#top" id="bottom">News</a></li>
                                  <li class="smaller3"><a class="whiteLink events" href="#top" id="bottom">Events</a></li>
                                  <li class="smaller3"><a class="whiteLink videos" href="#top" id="bottom">Videos</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
                            ...
                            <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                              <div class="card-body">
                                <ul>
                                  ...
                                  <li class="smaller3"><a class="whiteLink" href="careers.php#careerSecondAnchor">Training</a></li>
                                  <li class="smaller3"><a class="whiteLink" href="careers.php#careerSecondAnchor">Job Security</a></li>
                                  <li class="smaller3"><a class="whiteLink" href="careers.php#careerSecondAnchor">Opportunity</a></li>
