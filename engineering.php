...
<body>
  ...
  <section class="blocksTop">
          ...
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent">
                ...
                <h1 class="acq">Let your professional prowess</h1>
              </div>
              <h1 class="acq noMargin content-middle transparent">take flight</h1>

              <p class="small content-bottom transparent">AFCS employs thousands of engineers and other professionals to maintain Air Force facilities and physical infrastructure at installations around the country and around the world—everything from operational and training facilities to housing and utility systems.</p>

              <p class="small content-last transparent">Our civil engineering team also manages the natural environment around and near each installation, such as land, water, and air.</p>

              <p class="small content-secondLast transparent">To accomplish this AFCS equips its engineering team with civil engineers, architects, environmental specialists, biologists, housing managers, electricians, skilled laborers, and even firefighters.</p>

              <p class="small content-thirdLast transparent">Their tasks are varied and challenging and always rewarding.</p>
    ...
    box-shadow: 0px 10px 17px 3px rgba(0,0,0,0.56);">
                <iframe src="https://www.youtube.com/embed/AZDUf2q3Qp0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
  ...
  <section class="blocks2">
      <center>
        ...
        <p class="small content-middle transparent">If you are interested in exploring AFCS opportunities in civil engineering and related fields, register here to receive up-to-the-minute job openings as they become available.</p>
      ...
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <div class="bluish3 content-middle transparent">
            <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Engineering page');">Register</a></div>
            <div class="bluishButton new">
              <a class="white" href="careers.php#occupations" onclick="ga('send', 'event', 'Go to Careers page', 'click', 'Engineering page');">Back to Occupations</a>
            </div>
