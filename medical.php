      ...
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <div class="content-bottom transparent">
            ...
            <p class="small">Our staff enjoy a supportive work environment and are offered continuing education and training to hone skills and stay abreast with the latest treatment techniques. They also enjoy an emphasis on work-life balance where time with family and friends and enjoying pastimes are valued.</p>
          ...
          <div class="content-thirdLast transparent">
            ...
            <p class="small noMargin">Life, health, dental, and long-term care</p>
          </div>

          <div class="content-fourthLast transparent">
            <p class="new3">Retirement</p>
            <p class="small noMargin">Immediate coverage by the Federal Employees Retirement (FERS) System, part of a three-tiered system which contains:</p>
    ...
    <div class="row heros">
      <div class="col-xs-12 col-lg-12">
        ...
        <div class="bluish3 content-middle transparent">
          <div class="bluishButton"><a class="white" href="roa.phpl" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Medical page');">Register</a></div>
