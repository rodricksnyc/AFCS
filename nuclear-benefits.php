    ...
    <div class="container-fluid" id="mt67">
      <div class="row">
        <div class="col-xs-12 col-lg-12">
          <div id="hero-slider2">
            <div class="hero-slide" style="background-image: url('./images5/benefits-background.png');" role="img" aria-label="Nuclear Arms Benefits Landing Image - doctor with lab coat">
        ...
        <div class="container-fluid w800">
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              ...
              <p class="small content-middle transparent">When you join AFNWC, you become part of a highly respected community working on the utmost challenges in the world of aviation, and your benefits should reflect that.</p>
          ...
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent" style="-webkit-box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);-moz-box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);box-shadow: 0px -14px 40px -9px rgba(0,0,0,0.75);">
                ...
                <iframe src="https://www.youtube.com/embed/vxv90nB8LMU" title="Video: Logistics" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
      ...
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <div class="bluish3 content-middle transparent">
            <div class="bluishButton"><a class="white" href="roa.php" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Nuclear Benefits page');">Register</a></div>
