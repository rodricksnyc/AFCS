              ...
              <div class="col-xs-12 col-lg-12">
                ...
                <div class="content-middle transparent">
                  ...
                  <div class="content-bottom transparent">
                    <h1 class="acq two">Permanent Change of Station (PCS) Briefings and Videos</h1>
                  </div>
              ...
              <div class="row heros">
                ...
                <div class="col-xs-12 col-lg-12">
                  ...
                  <div class="content-top transparent">
                    ...
                    <h1 class="acq two">AF CIVILIAN EMPLOYMENT OVERSEAS<br>The Exceptional Family Member Program (EFMP)</h1>


                    <p class="whiteList"><span class="strong">Introduction:</span> It is DoD policy that considerations in reassigning a Service member shall be based on the policy stated in reference (a) and special needs of family members shall affect reassignments overseas solely according to this Instruction. Selection of civilians for overseas positions shall not be based on those individuals having family members with special needs.</p>
                  </div>
          ...
          <div class="row heros">
            <div class="col-xs-12 col-lg-12">
              ...
              <div class="bluish3 content-middle transparent">
                <div class="bluishButton"><a class="white" href="roa.php" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Regulatory page');">Register</a></div>
