          ...
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent">
                ...
                <h1 class="acq">Work shoulder to shoulder</h1>
              </div>
              <h1 class="acq noMargin content-middle transparent">with superheroes</h1>

              <p class="small content-bottom transparent">The Air Force defends our nation’s interests against enemies of all kinds, and in the 21st century one of the most highly contested arenas is the digital world. AFCS employs hundreds of highly trained specialists to help maintain and advance Air Force leadership and protection of cyberspace.</p>
      ...
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <div class="bluish3 content-middle transparent">
            <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Cyber page');">Register</a></div>
            <div class="bluishButton new">
              <a class="white" href="careers.php#occupations" onclick="ga('send', 'event', 'Go to Careers page', 'click', 'Cyber page');">Back to Occupations</a>
            </div>
