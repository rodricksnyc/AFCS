...
<body>
        ...
        <div class="container-fluid">
          <div class="row bottomBoxShadow">
            <div class="col-xs-12 col-lg-12">
              <div id="hero-slider2">
                <div class="hero-slide" style="background-image: url('./images5/aircraft.png');" role="img" aria-label="Aircraft Maintenance Landing Image - a man with aircraft mechanic gear on">
                  <div class="container">
                    <div class="row hero-content acq">
                      <div class="col-sm-12">
                        <div class="img-responsive slide-message" data-animation="fadeInUp" data-delay="0.8s">
                          <h1 class="sNew">AIRCRAFT</h1>
                        </div>
                        <div class="img-responsive slide-message" data-animation="fadeInUp" data-delay="0.9s">
                          <h1 class="sNew2">MAINTENANCE</h1>
                        </div>
  ...
  <section class="blocksTop">
          ...
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent">
                ...
                <h1 class="acq">Help maintain the greatest air force</h1>
              </div>
              <h1 class="acq noMargin content-middle transparent">in the world</h1>

              <p class="small content-bottom transparent">Our aircraft are as specialized as our mission and keeping each one ready for action is a big job. With teams of aircraft maintenance specialists around the country, the safety of our Airmen and the continued superiority of our Air Force is a daily preoccupation.</p>

              <p class="small content-last transparent">Electricians, engine mechanics, sheet metal workers, hydraulic, pneudraulic experts, and many other professionals with specialty skills fill the ranks of our maintenance team. Working on the most sophisticated and advanced fleet in the skies—fighter jets, bombers, surveillance and reconnaissance planes, transport and refueling planes, helicopters, and trainers—puts an important responsibility on our shoulders. A responsibility we carry proudly.</p>
    ...
    box-shadow: 0px 10px 17px 3px rgba(0,0,0,0.56);">
                <iframe src="https://www.youtube.com/embed/PKtxZJ83Nnc" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
  ...
  <section class="blocks22">
      <center>
        ...
        <p class="small content-middle transparent">If you are interested in being considered for an aircraft maintenance position with the Air Force Civilian Service, click the Register button below to provide us with your profile information and to upload your resume.</p>
        ...
        <div class="row heros">
          <div class="col-xs-12 col-lg-12">
            ...
            <div class="bluish3 content-middle transparent">
              <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Aircraft page');">Register</a></div>
              <div class="bluishButton new">
                <a class="white" href="careers.php#occupations" onclick="ga('send', 'event', 'Go to Careers page', 'click', 'Aircraft page');">Back to Occupations</a>
              </div>
