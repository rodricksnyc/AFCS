        ...
        <div class="container-fluid">
          <div class="row bottomBoxShadow">
            <div class="col-xs-12 col-lg-12">
              <div id="hero-slider2">
                <div class="hero-slide" style="background-image: url('./images5/administrative.png');" role="img" aria-label="Administrative Management Landing Image - a man in a suit smiling">
                  <div class="container">
                    <div class="row hero-content acq">
                      <div class="col-sm-12">
                        <div class="img-responsive slide-message" data-animation="fadeInUp" data-delay="0.8s">
                          <h1 class="sNew">ADMINISTRATIVE &</h1>
                        </div>
                        <div class="img-responsive slide-message" data-animation="fadeInUp" data-delay="0.9s">
                          <h1 class="sNew2">MANAGEMENT</h1>
                        </div>
          ...
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent">
                ...
                <h1 class="acq">Help Air Force leadership stay</h1>
              </div>
              <h1 class="acq noMargin content-middle transparent">on point</h1>

              <p class="small content-bottom transparent">Like any other large organization AFCS relies on confident and competent office personnel to provide leadership the daily support they need to maintain efficiency and optimal organization.</p>

              <p class="small content-last transparent">Management analysts, human resource specialists, executive assistants, secretaries, and many related staff and program assistants work behind the scene but right on the front lines of keeping the Air Force mission in focus: in air, space, and cyberspace</p>
              ...
              <p class="small content-thirdLast transparent">If you are interested in exploring opportunities in administrative and management positions at AFCS, register here to receive up-to-the-minute job openings as they become available.</p>
        ...
        <div class="row heros">
          <div class="col-xs-12 col-lg-12">
            ...
            <div class="bluish3 content-middle transparent">
              <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Administrative Page');">Register</a></div>
              <div class="bluishButton new">
                <a class="white" href="careers.php#occupations" onclick="ga('send', 'event', 'Go to Careers page', 'click', 'Administrative Page');">Back to Occupations</a>
              </div>
