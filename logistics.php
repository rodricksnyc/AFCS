...
<a href='#content' class='skipNav'>Skip to main content</a>
        ...
        <div class="container-fluid">
          <div class="row bottomBoxShadow">
            <div class="col-xs-12 col-lg-12">
              <div id="hero-slider2">
                <div class="hero-slide" style="background-image: url('./images5/logistics-main.png');" role="img" aria-label="Logistics Landing Image - a woman with glasses">
                  <div class="container">
                    <div class="row hero-content acq">
                      <div class="col-sm-12">
                        <div class="img-responsive slide-message" data-animation="fadeInUp" data-delay="0.8s">
                          <h1 class="sNew">LOGISTICS</h1>
                        </div>
                        <!-- <div class="img-responsive slide-message" data-animation="fadeInUp" data-delay="0.9s">
                          <h1 class="sNew2">SECURITY</h1>
                        </div> -->
  ...
  <section class="blocksTop">
          ...
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent">
                ...
                <h1 class="acq">Put people and supplies in the</h1>
              </div>
              <h1 class="acq noMargin content-middle transparent">right place at the right time</h1>

              <p class="small content-bottom transparent">From the world’s most advanced aircraft to the nuts and bolts that hold them together, the AFCS logistics team organizes and delivers virtually everything that’s needed to maintain Air Force superiority in air, space, and cyberspace.</p>

              <p class="small content-last transparent">Equipment, inventory, transportation, and quality assurance are managed by our team of white-collar and blue-collar professionals. Inventory and industrial specialists, management and scheduling experts, and a team of 43,000 colleagues who maintain purchasing and delivery of supplies of equipment and systems worldwide.</p>

              <p class="small content-secondLast transparent">It’s a complex and challenging undertaking but absolutely essential to maintaining U.S. Air Force superiority in air, space, and cyberspace.</p>
    ...
    box-shadow: 0px 10px 17px 3px rgba(0,0,0,0.56);">
                <iframe src="https://www.youtube.com/embed/Fi23Aektbi0" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
  ...
  <section class="blocks2">
      <center>
        ...
        <p class="small content-middle transparent">If you are interested in exploring AFCS opportunities in logistics related fields, register here to receive up-to-the-minute job openings as they become available.</p>
      ...
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <div class="bluish3 content-middle transparent">
            <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Logistics page');">Register</a></div>
            <div class="bluishButton new">
              <a class="white" href="careers.php#occupations" onclick="ga('send', 'event', 'Go to Careers page', 'click', 'Logistics page');">Back to Occupations</a>
            </div>
