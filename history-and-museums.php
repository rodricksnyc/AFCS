        ...
        <div class="container-fluid w800">
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              ...
              <p class="small content-middle transparent">A wise man said, “Those who do not learn from history are doomed to repeat it.” The History and Museums Program comprises a global network of trained, educated, and experienced professional historians, archivists, writers, and museum curators and specialists with a deep belief in the value of history's contributions to combat capability and program development. Personnel in the Air Force History and Museums Program are postured to meet their mission of improving United States Air Force combat capability through the collection, preservation, interpretation, dissemination, and display of historical information, artifacts, and United States Air Force heritage. </p>

              <p class="small content-bottom transparent">As an AFCS historian, you will be designated Emergency Essential and will be required to deploy in support of wartime, contingency, and/or humanitarian operations. You will be one of the authors of history, as you chronicle various operations and collect documentary material for future studies, addressing key issues such as mission, plans, policy formulation, and contingency operations.  Other positions require work at one of 12 United States Air Force museums or 7 heritage centers across the United States. At AFCS, you can be a part of history by making sure it is recorded and reported accurately. </p>
      ...
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <div class="bluish3 content-middle transparent">
            <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Museums page');">Register</a></div>
            <div class="bluishButton new">
              <a class="white" href="careers.php#occupations" onclick="ga('send', 'event', 'Go to Careers page', 'click', 'Museums page');">Back to Occupations</a>
            </div>
