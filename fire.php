...
<body>
  ...
  <section class="blocksTop">
          ...
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent">
                ...
                <h1 class="acq">Protect those who protect our</h1>
              </div>
              <h1 class="acq noMargin content-middle transparent">nation</h1>

              <p class="small content-bottom transparent">Every Air Force base, like every city and town, has a fire department. But in addition to being prepared for the kind of residential and commercial fire emergencies any community might face, our fire fighters are ready to meet the unique challenges of military and aviation-related situations involving jet and rocket fuel, munitions, and chemicals.</p>

              <p class="small content-last transparent">Our AFCS firefighters rely not only on their skills and an expert firefighting team but also on their experience in emergency management, rescue, paramedic, and other first-responder skills.</p>

              <p class="small content-secondLast transparent">Like our counterparts in other fire fighting forces, we at AFCS are committed to protecting our community. But we also contribute every day to the defense of our nation and the values we hold dear.</p>

              <p class="small content-thirdLast transparent">If you are interested in exploring AFCS opportunities in fire protection and related fields, register here to receive up-to-the-minute job openings as they become available.</p>
    ...
    box-shadow: 0px 10px 17px 3px rgba(0,0,0,0.56);">
                <iframe src="https://www.youtube.com/embed/YkzXUXWVJ4o" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
              </div>
  ...
  <section class="blocks2">
      <center>
        <div class="container-fluid w800">
          <div class="row heros">
            <div class="col-xs-12 col-lg-12">
          <p style="font-weight:lighter !important;font-family: "Roboto Condensed"" class="small content-top transparent">Unlike our counterparts in business and industry, we at AFCS are committed to something far more important than just the bottom line. We work every day in the defense of our nation and the values we hold dear.</p>

        <p class="small content-middle transparent">If you are interested in exploring AFCS opportunities in cyber security and IT, register here to receive up-to-the-minute job openings as they become available.</p>
      ...
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <div class="bluish3 content-middle transparent">
            <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Fire page');">Register</a></div>
            <div class="bluishButton new">
              <a class="white" href="careers.php#occupations" onclick="ga('send', 'event', 'Go to Careers page', 'click', 'Fire page');">Back to Occupations</a>
            </div>
