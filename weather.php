        ...
        <div class="container-fluid w800">
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              ...
              <p class="small content-middle transparent">Like everything else, America’s missions around the globe are impacted by the weather. The mission of the Air Force Weather Agency (AFWA) is to maximize America's power through the exploitation of timely, accurate, and relevant weather information; anytime, everywhere. </p>

              <p class="small content-bottom transparent">AFWA consists of more than 1,400 active-duty, Reserve, civilian, and contract personnel and is headquartered on Offutt Air Force Base, Neb.  Our meteorologists develop, direct, and coordinate meteorological weather studies and research to integrate current and forecasted atmospheric and space weather conditions into operational planning.  We also hire weather technicians, responsible for assessing the impact weather conditions have on weapon systems and missions, whether on a global scale or specific to a particular military operation.</p>
      ...
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <div class="bluish3 content-middle transparent">
            <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA', 'click', 'Weather page');">Register</a></div>
            <div class="bluishButton new">
              <a class="white" href="careers.php#occupations" onclick="ga('send', 'event', 'Go to Careers', 'click', 'Weather page');">Back to Occupations</a>
            </div>
