          ...
          <div class="row heros">
            ...
            <div class="col-xs-12 col-lg-12">
              <div class="content-top transparent">
                ...
                <h1 class="acq">Use your expertise to help</h1>
              </div>
              <h1 class="acq noMargin content-middle transparent">protect our nation</h1>

              <p class="small content-bottom transparent">Defending a nation is an expensive proposition. Skilled finance, accounting, and budgeting professionals enable AFCS to manage the resources necessary to maintain Air Force leadership in technology and capability.</p>

              <p class="small content-last transparent">While defense budgets are large, they are not unlimited. We ensure that taxpayer dollars are spent efficiently and effectively. Our team provides a variety of business functions, performing cost analysis and estimating, distribution and management of funds, and establishing performance standards to evaluate cost and efficacy.</p>
      ...
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <div class="bluish3 content-middle transparent">
            <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Finance page');">Register</a></div>
