                ...
                <div class="row hero-content acq">
                  <div class="col-sm-12 moveLeft">
                    <div class="img-responsive slide-message" data-animation="fadeInUp" data-delay="0.8s">
                      <h1 class="slicker">ROCKET</h1>
                    </div>
                    <div class="img-responsive slide-message" data-animation="fadeInUp" data-delay="0.8s">
                      <h1 class="slicker two">SCIENCE</h1>
                    </div>
                    <div class="img-responsive slide-message"  data-animation="fadeInUp" data-delay="1s">
                      <h1 class="slicker three">Space & Missile Systems Center</h1>
                    </div>
        ...
        <div class="row heros">
          <div class="col-xs-12 col-lg-12">
            <div class="content-top transparent">
              ...
              <h1 class="acq">Think Bigger</h1>
              <p class="small">Our ability to develop and maintain the world’s best space and missile technology rests on the skills dedicated civilian employees can bring to the table. At SMC, you don’t need a military background to build a career in space — you just need the ambition to think big.</p>
            </div>
            <p class="small content-middle transparent">At SMC, civilian employees work alongside members of the uniformed military, developing and maintaining the most advanced space and missile systems in the world. Joining our dedicated workforce means being part of the next generation of visionaries, informing our nation’s decision-makers, and enabling our next great achievements.</p>

            <p class="small content-bottom transparent"></p>
...
<section class="blocks">
    <center>
      <div class="container-fluid w800" style="padding-top:0px;margin-bottom:0px">
        <div class="row heros">
          <div class="col-xs-12 col-lg-12">
            <div class="content-top transparent">
...
<section class="blocks4" style="padding-top:0px;">
    <center>
      <div class="container-fluid w800" style="padding-top:0px">
        <div class="row heros">
          <div class="col-xs-12 col-lg-12">
