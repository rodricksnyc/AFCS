    ...
    <div class="container-fluid">
      <div class="row bottomBoxShadow">
        <div class="col-xs-12 col-lg-12">
          <div id="hero-slider2">
            <div class="hero-slide" style="background-image: url('./images5/pilot-main.png');" role="img" aria-label="Pilot and Simulator Instructors Landing Page - a plane engineer smiling">
              <div class="container">
                <div class="row hero-content acq">
                  <div class="col-sm-12">
                    <div class="img-responsive slide-message" data-animation="fadeInUp" data-delay="0.8s">
                      <h1 class="sNew">PILOT &</h1>
                    </div>
                    <div class="img-responsive slide-message" data-animation="fadeInUp" data-delay="0.9s">
                      <h1 class="sNew2">SIMULATOR</h1>
                    </div>
        ...
        <div class="row heros">
          ...
          <div class="col-xs-12 col-lg-12">
            <div class="content-top transparent">
              ...
              <h1 class="acq">Help train the greatest</h1>
            </div>
            <h1 class="acq noMargin content-middle transparent">Air Force in the world</h1>

            <p class="small content-bottom transparent">The United States Air Force is the most formidable air force on the planet. Respected and admired for the superiority of their aircraft as well as the skill of the pilots who fly them.</p>

            <p class="small content-last transparent">We are the team that trains the elite cadre of pilots at the heart of this mighty force. We guide student pilots from the classroom to the flight line. We train and retrain our experienced flyers in the latest systems and newest technology. And to keep them ready at a moment’s notice, we supervise and assist them while they invest hundreds of hours in flight simulator training at the finest facilities in the world.</p>

            <p class="small content-secondLast transparent">Our aircraft are as specialized as our mission and require highly trained instructors to prepare pilots to fly them. That’s where we step in. We are pilots ourselves—or former pilots—eager to make our contribution to the success of the Air Force mission, standing shoulder to shoulder with the men and women who patrol and protect the skies.</p>
        ...
        <div class="row heros">
          ...
          <div class="col-xs-12 col-lg-12">
            <div class="content-top transparent">
              ...
              <iframe src="https://www.youtube.com/embed/UY8UsSb8fb8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
    ...
    <div class="container-fluid w800">
      <div class="row heros">
        <div class="col-xs-12 col-lg-12">
          ...
          <p class="small content-middle transparent">If you are interested in exploring opportunities in training Air Force pilots at AFCS, register here to receive up-to-the-minute job openings as they become available.</p>
    ...
    <div class="row heros">
      <div class="col-xs-12 col-lg-12">
        ...
        <div class="bluish3 content-middle transparent">
          <div class="bluishButton"><a class="white" href="https://www.afciviliancareers.com/afciviliancareers" onclick="ga('send', 'event', 'Go to ROA page', 'click', 'Pilot page');">Register</a></div>
          <div class="bluishButton new">
            <a class="white" href="careers.php#occupations" onclick="ga('send', 'event', 'Go to Careers page', 'click', 'Pilot page');">Back to Occupations</a>
          </div>
